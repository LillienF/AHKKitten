...
@echo - The Kitten Script.exe file need to have already been compliled with Autohotkey
@echo ========================================================================================
@echo.

@echo off
@set /p version="version: "
@set packageName=Kitten_Script_v%version%
...
@robocopy "%PROJECT_DIR%" "Build\%packageName%" "Kitten Script.exe"
